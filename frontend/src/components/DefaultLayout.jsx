...
const DefaultLayout = ({ children }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen dark:bg-black p-4">
      <div className="flex flex-col w-[80%] h-[86vh] bg-[#0a0a0a] shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] shadow-neutral-800 dark:shadow-neutral-900 rounded-[2rem] border-4 border-neutral-800 text-white overflow-hidden">
        {children}
