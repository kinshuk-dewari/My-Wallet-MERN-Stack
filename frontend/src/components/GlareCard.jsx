...
//       className="relative inline-block isolate w-76 [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform"
//       onPointerMove={(event) => {
...
//           <div className={cn("h-full w-full bg-slate-950 relative z-10", className)}>
//             {children}
//           </div>
//         </div>
